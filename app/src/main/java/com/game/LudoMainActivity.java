...
public class LudoMainActivity extends AppCompatActivity implements UtilsAwv.Listener , AppKeyContact.View{
    ...
    public void adKeysResponse(ArrayList<AdKeysResponse> adKeysResponse) {
        ...
        {
            if (adKeysResponse.get(i).getName().equals("ludu  Interstitial ads"))
            {
                Preferences.saveValue(Preferences.Inter,adKeysResponse.get(i).getApikey());
            }else if (adKeysResponse.get(i).getName().equals("ludu banner"))
            {
